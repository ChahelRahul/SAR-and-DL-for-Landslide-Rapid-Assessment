...
def main() -> int:
    ...
    parser.add_argument("--manifest", type=Path, default=project_root / "model" / "weights-manifest.json")
    parser.add_argument("--directory", type=Path, default=project_root / "model" / "weights")
